  ...
  return (
    <footer className="w-full  text-white  bg-blue-logo-0   md:pt-7 pt-4  relative mt-20 ">
      <div className="container-base text-sm md:text-base md:container-xl flex flex-wrap lg:flex-nowrap lg:space-x-3 justify-between gap-y-4 ">
        ...
        <div className=" font-light space-y-4 md:max-w-[569px] lg:or ">
        ...
        <div className=" order-3 w-full lg:max-w-[400px] md:h-[255px] h-[315px] flex justify-center ">
          <iframe
      ...
      <div className="px-4 py-3 mt-4 text-blue-logo-0 bg-white flex justify-center text-sm md:gap-1 items-start md:items-center text-center font-bold">
        <Image
          alt="Copyright"
