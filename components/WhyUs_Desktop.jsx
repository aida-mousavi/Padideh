...
export default function WhyUs_Desktop() {
  ...
  return (
    <section className="container-xl mt-16 hidden md:block ">
...
<Title title={whyOurPanelTitle.title} description={whyOurPanelTitle.description}/>
      ...
      <PicBorder>
        ...
        <Image className="  max-w-[21vw] xl:max-w-[281.05px] xl:max-h-[408.99px] object-cover " alt="Panel Sheet" src={PanelSheet} />
        </div>
