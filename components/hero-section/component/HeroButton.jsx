...
export default function HeroButton() {
  return (
    ...
    <Link href={"#"} className="cursor-pointer  px-3 h-6 md:w-[211px] md:h-[45px] bg-white text-black flex justify-between items-center  rounded-full text-center ">
    ...
    <Link href={"#"}  className="cursor-pointer px-2   h-6  md:w-[178px] md:h-[45px]  text-white  border border-white flex justify-center items-center content-center gap-1 rounded-full text-center ">
        <Image
          alt="Download Icon"
